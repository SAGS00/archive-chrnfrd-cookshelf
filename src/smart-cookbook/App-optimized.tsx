...
export default function App() {
    ...
    const { mealPlan, updateMealPlan, getIngredientsFromMealPlan } =
        useMealPlan();

    const { shoppingList, addMultipleItems, updateItems } = useShoppingList();
    ...
    const handleSaveRecipe = useCallback(
        ...
        [editingRecipe, updateRecipe, addRecipe]
    );
    ...
    const handleGenerateShoppingList = useCallback(() => {
        const ingredients = getIngredientsFromMealPlan(recipes);
        addMultipleItems(ingredients);
        setActiveTab("shopping");
    }, [getIngredientsFromMealPlan, recipes, addMultipleItems]);
    ...
    }, [searchQuery, categoryFilter, difficultyFilter, showFavoritesOnly]);
